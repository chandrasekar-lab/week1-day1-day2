...
public class Calculator {
	...
	public int additionOfThreeNumbers(int num1, int num2, int num3) {
		int sum = num1 + num2 + num3;
		return (sum);
	}

	public int subtractionOfTwoNumbes(int num1, int num2) {
		int sub = num1 - num2;
		return (sub);
	}

	public double multipilcationOfTwoNumbersNum(int num1, int num2) {
		double mul = num1 * num2;
		return (mul);
	}

	public float divisionMethod(int num1, int num2) {
		float div = num1 / num2;
		return (div);
	}
